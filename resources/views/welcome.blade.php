...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="welcome-shell">
        <header class="welcome-nav">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h1 class="mt-3 text-xl font-semibold" style="color: var(--pf-text);">Precifica Facil</h1>
                </div>
            </div>
        ...
        <main class="welcome-hero">
            <section>
                <p class="welcome-kicker">Gestao, custo e venda no mesmo fluxo</p>
                <h2 class="welcome-title">Precifique produtos alimenticios com clareza, velocidade e padrao profissional.</h2>
                <p class="welcome-copy">
                    O Precifica Facil ajuda doceiras, confeiteiras, salgadeiras, marmiteiras e pequenos negocios de alimentacao a organizar ingredientes, receitas, embalagens, canais de venda e precos finais em um painel simples de operar no dia a dia.
                </p>
                ...
                <div class="mt-10 grid gap-4 sm:grid-cols-3">
                    ...
                    <div class="welcome-metric">
                        ...
                        <p class="metric-value text-2xl">Preco por venda</p>
            ...
            <aside class="welcome-panel">
                ...
                <h3 class="mt-4 text-2xl font-semibold" style="color: var(--pf-text);">Monte a base certa antes de formar o preco.</h3>
                <div class="mt-6 space-y-4">
                    ...
                    <div class="channel-price-item" style="background: #fff7ed;">
                        ...
                        <span class="badge-warning">Taxas e preco final</span>
                    </div>
                </div>
                ...
                <div class="mt-8 rounded-[24px] border p-5" style="border-color: var(--pf-border); background: #f8fafc;">
                    ...
                    <ul class="mt-4 space-y-3 text-sm" style="color: var(--pf-text-soft);">
                        ...
                        <li>Preco sugerido do produto</li>
                        <li>Preco especifico por canal de venda</li>
                    </ul>
                </div>
            </aside>
        </main>
